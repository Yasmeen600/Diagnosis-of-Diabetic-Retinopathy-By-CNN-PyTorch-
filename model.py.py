...
train_set = torchvision.datasets.ImageFolder(root='/Users/FreeComp/Desktop/graduation project/DR code and data/diagonisis of retinopathy data/train', transform=transform) 
train_set.transform
val_set = torchvision.datasets.ImageFolder(root='/Users/FreeComp/Desktop/graduation project/DR code and data/diagonisis of retinopathy data/valid', transform=transform)
val_set.transform
test_set = torchvision.datasets.ImageFolder(root='/Users/FreeComp/Desktop/graduation project/DR code and data/diagonisis of retinopathy data/test', transform=transform)
test_set.transform
